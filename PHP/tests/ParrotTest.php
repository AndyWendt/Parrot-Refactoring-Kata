...
class ParrotTest extends TestCase
{
    ...
    {
        $parrot = Parrot::instance(ParrotTypeEnum::EUROPEAN, 0, 0, false);
        self::assertSame(12.0, $parrot->getSpeed());
    }

    public function testSpeedOfAfricanParrotWithOneCoconut(): void
    {
        $parrot = Parrot::instance(ParrotTypeEnum::AFRICAN, 1, 0, false);
        self::assertSame(3.0, $parrot->getSpeed());
    }

    public function testSpeedOfAfricanParrotWithTwoCoconuts(): void
    {
        $parrot = Parrot::instance(ParrotTypeEnum::AFRICAN, 2, 0, false);
        self::assertSame(0.0, $parrot->getSpeed());
    }

    public function testSpeedOfAfricanParrotWithNoCoconuts(): void
    {
        $parrot = Parrot::instance(ParrotTypeEnum::AFRICAN, 0, 0, false);
        self::assertSame(12.0, $parrot->getSpeed());
    }

    public function testSpeedNorwegianBlueParrotNailed(): void
    {
        $parrot = Parrot::instance(ParrotTypeEnum::NORWEGIAN_BLUE, 0, 1.5, true);
        self::assertSame(0.0, $parrot->getSpeed());
    }

    public function testSpeedNorwegianBlueParrotNotNailed(): void
    {
        $parrot = Parrot::instance(ParrotTypeEnum::NORWEGIAN_BLUE, 0, 1.5, false);
        self::assertSame(18.0, $parrot->getSpeed());
    }

    public function testSpeedNorwegianBlueParrotNotNailedHighVoltage(): void
    {
        $parrot = Parrot::instance(ParrotTypeEnum::NORWEGIAN_BLUE, 0, 4, false);
        self::assertSame(24.0, $parrot->getSpeed());
    }

    public function testAnUnknownParrotWillWillThrownAnExceptionForGetSpeed(): void
    {
        $this->expectExceptionMessage('Should be unreachable');
        $unknownParrot = Parrot::instance(-1, 0, 0, false);
        $unknownParrot->getSpeed();
    }

    public function testAnUnknownParrotWillWillThrownAnExceptionForGetCry(): void
    {
        $this->expectExceptionMessage('Should be unreachable');
        $unknownParrot = Parrot::instance(-1, 0, 0, false);
        $unknownParrot->getCry();
    }
    ...
    {
        $parrot = Parrot::instance(ParrotTypeEnum::NORWEGIAN_BLUE, 0, 0, false);
